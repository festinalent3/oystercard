...
PENALTY_FEE = 6
  ...
  def calculate_fare
    return PENALTY_FEE if entry_station == nil
    #ADD PENALTY FARE
...
# That makes it possible tho raise an error when customers forgot to touch in and then touches out on another station
